...
### Цель: развернуть в Яндекс Клауд следующую конфигурацию с помощью terraform


### Описание/Пошаговая инструкция выполнения домашнего задания:
Виртуалка с iscsi - 3 виртуальные машины с разделяемой файловой системой GFS2 поверх cLVM
...
вместо Yandex Cloud можно использовать
...
К сожалению во многом рутинная боль отуса - это презентации к уроку (методички) устаревшие (основанные на версиях linux - в deprecated)

И во многом в реализации ДЗ они только мешают, так как дают неверное направление поиска (и пакетов) на которое тратится огромное количество времени.
